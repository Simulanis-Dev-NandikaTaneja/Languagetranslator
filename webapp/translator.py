...
def eng_to_hindi(textfile):
    ...
    #path1="C:\\Nandika\\lttool\\webapp\\uploads\\"+dir1
    #path2="C:\\Nandika\\lttool\\webapp\\uploads\\"+dir2
    path1="uploads\\"+dir1
    path2="uploads\\"+dir2
    print(path1)
    ...
    if textfile.endswith(".xlsx"):
        try:
            ...
            for i in df.index:
                ...
                if a!=" ":
                    ...
                    #zipp="C:\\Nandika\\lttool\\webapp\\uploads\\"+dir1
                    #zipp1="C:\\Nandika\\lttool\\webapp\\uploads\\"+dir2
                    zipp="uploads\\"+dir1
                    zipp1="uploads\\"+dir2
                    print(zipp)
                    auddir=dir1+'.zip'
                    ...
                    continue
            #writer = pd.ExcelWriter("C:\\Nandika\\lttool\\webapp\\uploads\\"+fname)
        ...
        try:
            ...
            for i in df.index:
                ...
                if a!=" ":
                    ...
                    continue
            #df.to_csv("C:\\Nandika\\lttool\\webapp\\uploads\\"+fname,encoding="utf-8")
        ...
        try: 
            #f1=open("C:\\Nandika\\lttool\\webapp\\uploads\\"+fname,"w",encoding="utf-8")
            ...
            f1.close()
            #ff=open("C:\\Nandika\\lttool\\webapp\\uploads\\"+fname, "r")
